...
try:
    ...
    print(f"[Machine Learning.ipynb] Saved plan_risk_map_cache.pkl to {_map_out}")
except Exception as _e_cs:
    print(f"[Machine Learning.ipynb] Could not save plan_risk_map_cache.pkl: {_e_cs} (non-fatal)")
...
# %%
# Sanity check to see if it totals to 1
